...
FILE=/usr/share/kibana/src/legacy/ui/public/assets/favicons_bu
if [ ! -d "$FILE" ]; then 
...
# custom throbber
FILE=/usr/share/kibana/src/legacy/ui/ui_render/views/ui_app.pug_bu
if [ ! -f "$FILE" ]; then 
...
FILE=/usr/share/kibana/src/legacy/ui/ui_render/views/chrome.pug_bu
if [ ! -f "$FILE" ]; then 
  cp /usr/share/kibana/src/legacy/ui/ui_render/views/chrome.pug /usr/share/kibana/src/legacy/ui/ui_render/views/chrome.pug_bu
...
# custom plugin css
FILE=/usr/share/kibana/src/legacy/ui/ui_render/ui_render_mixin.js_bu
if [ ! -f "$FILE" ]; then   
...
FILE=/usr/share/kibana/built_assets/dlls/vendors.bundle.dll.js_bu
if [ ! -f "$FILE" ]; then 
  ...
  sed -i 's/euiHeaderChildSize:"48px"/euiHeaderChildSize:"60px"/g' /usr/share/kibana/built_assets/dlls/vendors.bundle.dll.js
fi

#build zip
zip -r ma-branding.zip kibana
cp ma-branding.zip /usr/share/kibana
cd /usr/share/kibana
